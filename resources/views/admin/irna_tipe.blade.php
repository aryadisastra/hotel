...
<main>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" tipe="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" tipe="document">
    ...
    <!-- MODAL EDIT -->
    <div class="modal fade" id="editModal" tabindex="-1" tipe="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" tipe="document">
            <div class="modal-content">
            <div class="modal-header">
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if(res != null || res != undefined) {
                    ...
                    if(res.status == 1) $('#editStatusAktif').prop('checked',true)
                    if(res.status == 2) $('#editStatusNonAktif').prop('checked',true)
